...
class FrndsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create frnd" do
    assert_difference("Frnd.count") do
      post frnds_url, params: { frnd: { Email: @frnd.Email, first_name: @frnd.first_name, last_name: @frnd.last_name, phone_no: @frnd.phone_no, twitter: @frnd.twitter } }
    end
  ...
  test "should update frnd" do
    patch frnd_url(@frnd), params: { frnd: { Email: @frnd.Email, first_name: @frnd.first_name, last_name: @frnd.last_name, phone_no: @frnd.phone_no, twitter: @frnd.twitter } }
